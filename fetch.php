...
if(isset($_POST['search'])){
    ...
    $query = "SELECT DISTINCT from_location FROM bus_table WHERE from_location LIKE '%$q%'"; 
    ...
    if(mysqli_num_rows($res)>0){
        ...
        while($row = mysqli_fetch_assoc($res)){
            ...
            $response .= "<li style='height: 50px;' id='".$_POST['id_pass']."' class='list-group-item'>".$row['from_location']."</li>";
        }
